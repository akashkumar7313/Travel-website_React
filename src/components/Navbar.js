...
import logo from "../components/assests/taxi_logos_PNG12.png";  
...
export default function Navbar() {
    ...
    return (
        <div>
            <div>
                <div className="bg-gradient-to-r from-yellow-300 via-blue-500 to-purple-600 h-[75px] lg:h-[60px] w-[100%]">
                    <ul className='md:ml-8 flex flex-wrap md:gap-0 lg:gap-14 sm:pt-4 sm:ml-2 text-[12px] sm:text-[14px] font-semibold justify-center  md:pt-2 lg:pt-[14px] text-white drop-shadow-md'>
